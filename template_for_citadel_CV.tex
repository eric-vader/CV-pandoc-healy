...
% \section{Personal Proj.}
% $for(personal_projects)$
%   \subsection{$personal_projects.type$}
%   $for(personal_projects.items)$
%     \begin{separator}
%       \entry{>}{\textit{$personal_projects.items.item$}
%         $if(personal_projects.items.info)$
%           \\\justifying{\noindent\small $personal_projects.items.info$ }
%         $endif$
%       }
%     \end{separator}
%     \vspace{-\commonspace}
